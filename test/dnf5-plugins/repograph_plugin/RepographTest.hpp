...
class RepographTest : public CppUnit::TestCase {
    ...
    CPPUNIT_TEST(test_provider_policy_option);
    CPPUNIT_TEST(test_node_id_option);
    CPPUNIT_TEST(test_edge_annotations_option);
...
public:
    ...
    void test_provider_policy_option();
    void test_node_id_option();
    void test_edge_annotations_option();
